...
return [
    ...
    | Hãy tùy chỉnh các thông báo này nếu cần thiết.
    |
    */
    ...
    'min' => [
        ...
        'file' => 'Trường :attribute phải có kích thước tối thiểu :min kilobytes.',
    ...
    |--------------------------------------------------------------------------
    |
    | Ở đây, bạn có thể chỉ định các thông báo validation tùy chỉnh cho các
    | thuộc tính bằng cách sử dụng quy ước "attribute.rule" để đặt tên dòng.
    | Điều này giúp nhanh chóng xác định một thông báo cụ thể cho một quy tắc
    ...
    */
    ...
    'custom' => [
        'start_time' => [
            ...
            'date_format' => 'Giờ bắt đầu không đúng định dạng',
        ],
        'end_time' => [
            'required' => 'Giờ kết thúc là bắt buộc',
            'date_format' => 'Giờ kết thúc không đúng định dạng',
        ...
        'court_id' => [
            'required' => 'Sân không được để trống',
            'exists' => 'Sân không tồn tại',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau có thể được sử dụng để đổi tên các placeholder
    | thuộc tính thành một cái gì đó dễ đọc hơn như "Địa chỉ Email" thay vì
    | "email". Điều này giúp thông báo của bạn dễ hiểu hơn.
    |
    */
