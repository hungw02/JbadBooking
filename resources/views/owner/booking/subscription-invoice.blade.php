...
<head>
    ...
    <title>Hóa đơn đặt sân định kỳ #{{ $booking->id }}</title>
...
<body class="bg-white p-6">
    <div class="max-w-3xl mx-auto bg-white p-8 border border-gray-200 rounded-lg">
        ...
        <div class="flex justify-between items-center border-b border-gray-200 pb-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">HÓA ĐƠN ĐẶT SÂN ĐỊNH KỲ</h1>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <p class="text-gray-600">Thời gian áp dụng:</p>
                    <p class="font-medium">
