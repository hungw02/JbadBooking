...
@section('title', 'Chi tiết lịch đặt định kỳ')
...
<div class="max-w-7xl mx-auto p-5">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-blue-600 p-4">
            <h1 class="text-white text-xl font-bold">Chi tiết lịch đặt định kỳ #{{ $booking->id }}</h1>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-blue-50 rounded-lg p-4 border border-blue-100">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{ $totalSessions }} buổi</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Còn lại:</span>
                            <span class="font-medium">{{ $remainingSessions }} buổi</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 rounded-lg p-4 border border-green-100">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">
                                ...
                                @elseif($booking->payment_method == 'wallet')
                                    <span class="flex items-center">
                                        <i class="fa-solid fa-money-bill mr-1 text-green-500"></i>
                                        Ví cá nhân
                                    </span>
                                @endif
                            </span>
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">Ngày đặt sân:</span>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{ \Carbon\Carbon::parse($booking->cancel_time)->format('d/m/Y H:i') }}</span>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            @if($booking->status == 'cancelled')
                ...
                <div class="mt-6 bg-orange-50 rounded-lg p-4 border border-orange-100">
                    <h2 class="text-lg font-semibold text-orange-800 mb-4 pb-2 border-b border-orange-200">
                        <i class="fa-solid fa-money-bill-transfer mr-2"></i>Thông tin hoàn tiền (Refunds)
                    </h2>
            ...
            <div class="mt-6 flex flex-wrap gap-3 justify-center">
                <a href="{{ route('booking.subscription.change', $booking->id) }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded transition">
                    <i class="fa-solid fa-exchange-alt mr-2"></i> Đổi sân
                </a>
                <form action="{{ route('booking.subscription.cancel', $booking) }}" method="POST" class="inline-block" onsubmit="return confirm('Bạn có chắc chắn muốn hủy đặt sân định kỳ này? Việc hủy sẽ áp dụng chính sách hoàn tiền theo quy định.')">
                    @csrf
                    @method('PUT')
    ...
    <div class="mt-8">
        ...
        <div class="bg-white p-4 rounded-lg shadow">
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <li>Hủy trước ngày chơi đầu tiên trên 24 tiếng: hoàn 50% số tiền đã thanh toán.</li>
                <li>Hủy trước ngày chơi đầu tiên từ 12-24 tiếng: hoàn 25% số tiền đã thanh toán.</li>
                ...
                <li><strong>Hủy đặt sân định kỳ sẽ bị trừ 5 điểm thân thiết</strong>.</li>
            </ul>
        </div>
    </div>
    @endif
